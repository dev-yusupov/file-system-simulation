...
class Directory(Node):
    """
    Directory class inherits from Node class and represents a directory in the file system.
    """
    ...
    def __repr__(self) -> str:
        return f"Directory(name={self.name}, parent={self.parent}, created_at={self.created_at}, updated_at={self.updated_at})"
