...
This class represents a node in a tree data structure. Each node has a name, a parent node, and a timestamp for when the node was created.
...
class Node:
    ...
    def __init__(self, name: str, parent: Optional['Node'] = None, created_at: Optional[datetime] = None, updated_at: Optional[datetime] = None) -> None:
        """
